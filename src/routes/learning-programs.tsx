...
function ProgramsPage() {
  ...
  return <><PageHeader title="Learning Programs" subtitle="Monitor access, participation and learning outcomes across partner-delivered programs." /><div className="space-y-4 p-4 sm:p-5 xl:p-6"><div className="grid gap-2.5 sm:grid-cols-2 xl:grid-cols-4"><KpiCard label="Program Enrolments" value={total} change={9.1} icon={UsersRound} tone="blue" /><KpiCard label="Active Learners" value={active} change={7.4} icon={BookOpenCheck} tone="green" /><KpiCard label="Learning Hours" value={hours} change={11.6} icon={Clock3} tone="maroon" /><KpiCard label="Average Completion" value={avg} suffix="%" change={4.3} icon={CircleCheck} tone="amber" /></div><SectionCard title="Learning Programs" subtitle="Three focused programs supporting career readiness and competitive examination preparation."><ProgramCards programs={programs} detailed /></SectionCard></div></>;
}
